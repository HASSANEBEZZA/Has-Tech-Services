    ...
    <section id="services" className="py-16">
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-8">
          ...
          Basés à Senlis, dans le département de l’Oise, nous intervenons dans les principales villes de la région, telles que Noyon, Clermont, Compiègne, Creil, Beauvais, Méru et Senlis.

Nous opérons également dans le nord de la France, avec une présence notable à Cambrai, Douai, Valenciennes, Béthune et Arras.

Que ce soit en milieu urbain ou rural, nous nous engageons à répondre à vos besoins avec efficacité et proximité. Des frais de déplacement s’appliquent pour les interventions situées au-delà de 20 km
